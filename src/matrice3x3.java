...
public class matrice3x3 {
  ...
  public matrice3x3() { matrice = generaMatrice(); }
  ...
  private char[][] generaMatrice() {
    ...
    for (int i = 0; i < 3; i++) {
      for (int j = 0; j < 3; j++) {
        ...
        nuovaMatrice[i][j] = (char)(random.nextInt(26) +
                                    'a'); // genero una lettera casuale dalla a
                                          // alla z usando codice ascii
      }
    }
  ...
  public void
  stampaMatrice() { // metodo per stampare la matrice sotto forma di griglia
